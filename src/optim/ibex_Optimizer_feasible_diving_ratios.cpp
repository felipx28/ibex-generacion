...
Optimizer::Status Optimizer::optimize() {
	...
	try {
		...
		std::ofstream InputFile("/home/felipe/Documents/magister/model2/input/prueba_nuevo_dataset/input_prueba_02_12_25.txt", std::ios::app);
		std::ofstream OutputFile("/home/felipe/Documents/magister/model2/output/prueba_nuevo_dataset/output_prueba_02_12_25.txt", std::ios::app);
		...
		for (int k = 0 ; k < num_sim ; k++){
			...
			variables = n;
			active = system.active_ctrs(aux.front()->box);
